...
var I = getDefaultExportFromCjs(C.exports);
...
var W = [ 52001, 52002, 52004, 52003, O, V, P, j, M ];
...
exports.getGraphQLDiagnostics = function getGraphQLDiagnostics(t, i, r) {
  ...
  if (s) {
    var d = findAllPersistedCallExpressions(a).map((e => {
      ...
      var i, s, n, o, l = t;
      if (e.typeArguments) {
        var [u] = e.typeArguments;
        n = u.getStart();
        o = u.getEnd() - u.getStart();
        if (!exports.ts.isTypeQueryNode(u)) {
          return {
            category: exports.ts.DiagnosticCategory.Warning,
            code: V,
            file: a,
        ...
        var {node: h, filename: p} = getDocumentReferenceFromTypeQuery(u, t, r);
        i = h;
        l = p;
        s = u.getText();
        ...
        var {node: f, filename: c} = getDocumentReferenceFromDocumentNode(e.arguments[1], t, r);
        i = f;
        l = c;
      ...
      var d = i;
      if (!d || !exports.ts.isCallExpression(d) || !exports.ts.isNoSubstitutionTemplateLiteral(d.arguments[0])) {
        return {
          category: exports.ts.DiagnosticCategory.Warning,
          code: j,
          file: a,
      ...
      if (e.arguments[0].getText().slice(1, -1).startsWith("sha256:")) {
        var v = generateHashForDocument(r, d.arguments[0], l);
        if (!v) {
          return null;
        }
        if (`sha256:${v}` !== v) {
...
exports.getPersistedCodeFixAtPosition = function getPersistedCodeFixAtPosition(e, t, i) {
  ...
  var a = s;
  if (exports.ts.isVariableStatement(a)) {
    a = a.declarationList.declarations.find((e => exports.ts.isVariableDeclaration(e) && e.initializer && exports.ts.isCallExpression(e.initializer))) || s;
  } else if (exports.ts.isVariableDeclarationList(a)) {
    a = a.declarations.find((e => exports.ts.isVariableDeclaration(e) && e.initializer && exports.ts.isCallExpression(e.initializer))) || s;
  } else if (exports.ts.isVariableDeclaration(a) && a.initializer && exports.ts.isCallExpression(a.initializer)) {
    a = a.initializer;
  } else {
    while (a && !exports.ts.isCallExpression(a)) {
      a = a.parent;
    }
  }
  if (!exports.ts.isCallExpression(a) || !(e => {
    var t = e.getText();
    var [i, r] = t.split(".");
    return A.has(i) && "persisted" === r;
  })(a.expression) || !a.typeArguments && !a.arguments[1]) {
    return;
  }
  var n, o = e;
  if (a.typeArguments) {
    var [l] = a.typeArguments;
    ...
    n = u;
    o = h;
  } else if (a.arguments[1]) {
    if (!exports.ts.isIdentifier(a.arguments[1]) && !exports.ts.isCallExpression(a.arguments[1])) {
      return;
    }
    var {node: p, filename: f} = getDocumentReferenceFromDocumentNode(a.arguments[1], e, i);
    n = p;
    o = f;
  }
  if (!n) {
  ...
  var c = n;
  if (!c || !exports.ts.isCallExpression(c) || !exports.ts.isNoSubstitutionTemplateLiteral(c.arguments[0])) {
    return;
  }
  var d = generateHashForDocument(i, c.arguments[0], o);
  var v = a.arguments[0];
  if (!v) {
    return {
      span: {
        start: a.arguments.pos,
        length: 1
      },
      replacement: `"sha256:${d}")`
    };
  } else if (exports.ts.isStringLiteral(v) && v.getText() !== `"sha256:${d}"`) {
    return {
      span: {
        start: v.getStart(),
  ...
  } else if (exports.ts.isIdentifier(v)) {
    return {
      span: {
        start: v.getStart(),
        length: v.end - v.getStart()
