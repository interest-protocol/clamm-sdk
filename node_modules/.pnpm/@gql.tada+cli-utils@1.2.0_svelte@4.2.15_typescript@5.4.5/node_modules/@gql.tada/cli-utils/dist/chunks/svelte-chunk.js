...
exports.createVirtualCode = (t, a, i) => {
  ...
  for (var h = 0; h < f.length; h++) {
    for (var v of f[h]) {
      ...
      if (u) {
        var p = d - u.genOffset;
        var m = s.substring(u.sourceOffset, u.sourceOffset + p);
        var O = o.code.substring(u.genOffset, u.genOffset + p);
        if (m !== O) {
          p = 0;
          for (var x = 0; x < d - u.genOffset; x++) {
            if (m[x] === O[x]) {
              p = x + 1;
            } else {
              break;
        ...
        if (p > 0) {
          ...
          if (_ && _.generatedOffsets[0] + _.lengths[0] === u.genOffset && _.sourceOffsets[0] + _.lengths[0] === u.sourceOffset) {
            _.lengths[0] += p;
          } else {
            g.push({
