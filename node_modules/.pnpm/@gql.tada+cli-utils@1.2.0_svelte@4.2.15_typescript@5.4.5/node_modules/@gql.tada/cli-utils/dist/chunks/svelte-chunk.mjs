import { svelte2tsx as e } from "svelte2tsx";
  ...
  update(e, t) {
    for (var r of e) {
      if (FullTextDocument.isIncremental(r)) {
        ...
        var h = r.text.length - (i - a);
        if (0 !== h) {
          for (var u = s + 1 + l.length, v = f.length; u < v; u++) {
            f[u] = f[u] + h;
          }
        }
...
var createVirtualCode = (t, a, i) => {
  var s = a.getText(0, a.getLength());
  var o;
  try {
    o = e(s, {
      filename: t,
  ...
  var f = r.decode(o.map.mappings);
  var l = n.create("", "svelte", 0, s);
  var c = n.create("", "typescript", 0, o.code);
  var g = [];
  var h;
  for (var u = 0; u < f.length; u++) {
    for (var v of f[u]) {
      ...
      if (h) {
        var p = d - h.genOffset;
        var m = s.substring(h.sourceOffset, h.sourceOffset + p);
        var O = o.code.substring(h.genOffset, h.genOffset + p);
        if (m !== O) {
          p = 0;
          for (var x = 0; x < d - h.genOffset; x++) {
            if (m[x] === O[x]) {
              p = x + 1;
            } else {
              break;
        ...
        if (p > 0) {
          var _ = g.length ? g[g.length - 1] : void 0;
          if (_ && _.generatedOffsets[0] + _.lengths[0] === h.genOffset && _.sourceOffsets[0] + _.lengths[0] === h.sourceOffset) {
            _.lengths[0] += p;
          } else {
            g.push({
              sourceOffsets: [ h.sourceOffset ],
              generatedOffsets: [ h.genOffset ],
              lengths: [ p ],
              data: {
                verification: !0,
                completion: !0,
      ...
      if (void 0 !== v[2] && void 0 !== v[3]) {
        h = {
          genOffset: d,
          sourceOffset: l.offsetAt({
            line: v[2],
            character: v[3]
          })
        };
  ...
  return {
    ...
    snapshot: i.ScriptSnapshot.fromString(o.code),
    mappings: g,
    embeddedCodes: []
  };
};
